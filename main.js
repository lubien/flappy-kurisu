...
function preload() {
    var assets = {
        spritesheet: {
            birdie: ['assets/kurisu2.png', 200, 200],
...
function reset() {
    ...
    scoreText.setText("TOQUE NA\nWAIFU DO\nRENATO");
    instText.setText("TOQUE PARA IRRITAR\nO RENATO FIGUEIREDO");
    gameOverText.renderable = false;
    birdie.body.allowGravity = false;
    birdie.angle = 0;
    birdie.reset(game.world.width / 4, game.world.height / 2);
    birdie.scale.setTo(0.4, 0.4);
...
function setGameOver() {
    gameOver = true;
	scoreText.setText("ZUERA BY:\nLUBIEN");
    instText.setText("TOQUE NA\nKURISU");
